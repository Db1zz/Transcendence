					...
					{mobileSettingsView === "menu" ? (
						<div className="flex flex-col h-full min-h-0">
							...
							<div className="flex-1 min-h-0 overflow-y-auto p-4 space-y-3">
								<SettingsButton onClick={openMobileProfile} text={t("settings.myProfile")} />
								<SettingsButton onClick={openMobileLanguage} text={t("settings.language")} />
								<Button onClick={handleLogout} className="w-full !px-3 !py-2 text-sm">
									{t("common.logout")}
								</Button>
							</div>
						</div>
