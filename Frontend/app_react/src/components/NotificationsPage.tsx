...
export const NotificationsPage: React.FC = () => {
  ...
  const { notifications, dismissNotification, dismissNotifications } =
    useNotifications();
      ...
      return {
        ...
        message:
          typeof payload?.content === "string"
            ? payload.content
            : t("notifications.genericBody", "You have a new update."),
        subtitle: senderName,
        badge: item.scope,
        avatarUrl,
            ...
            <div>
              ...
              <p className="mt-1 font-roboto text-sm text-gray-600">
                {t(
                  ...
                  "messages stay out of this view. other alerts will appear here.",
                )}
              </p>
            </div>
          </div>
