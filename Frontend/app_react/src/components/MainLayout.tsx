...
const mockMembers: Member[] = [
    ...
    { id: "2d907254-c612-45e8-8925-6e3870369930", name: "Test User", status: "online" }
];
                    ...
                    return {
                        ...
                        channels: cat.channels.map((ch) => {
                            ...
                            if (data.action === "JOIN" && String(ch.id) === String(data.channelId)) {
                                const matchedMember = mockMembers.find(m => String(m.id) === String(data.userId));
                                const fallbackName = `User (${String(data.userId).slice(0, 4)})`; 
                                
                                updatedUsers.push({
                                    id: String(data.userId),
                                    name: data.userName || matchedMember?.name || fallbackName,
